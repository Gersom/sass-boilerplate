...
La mayoria de los proyectos tienen una carpeta `vendors/`, esta conteniendo todos los archvos CSS externos, hojas de estilo de librerias y frameworks como Normalize, Bootstrap, jQueryUI, owlCarousel, etc., Poniendo en una carpeta separada en una buena manera de decir "Hey, esto no es mio, no es mi codigo, no es mi responsabilidad".
